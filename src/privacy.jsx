      ...
      <div className="space-y-6">
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <li><strong>Application</strong> refers to <strong>BOOZO CABS</strong>, the software program provided by the Company.</li>
            <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to <strong>BOOZO CABS Private Limited</strong>, [Insert Address Here], India.</li>
        ...
        <section>
          <p className="mb-2 font-medium">We may share Your personal information in the following situations:</p>
          <ul className="list-disc list-inside space-y-2 ml-4">
